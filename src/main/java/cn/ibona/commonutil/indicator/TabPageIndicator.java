 ...
 */
package cn.ibona.commonutil.indicator;
...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private class TabView extends TextView {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (mMaxTabWidth > 0 && width > mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(mMaxTabWidth-80, MeasureSpec.EXACTLY),
                        heightMeasureSpec);
            }
        }
...
/**
 indicatorActivityJoblist.setViewPager(vpActivityJoblist);


 vpActivityJoblist.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
@Override
...
indicatorActivityJoblist.onPageSelected(position);
}
